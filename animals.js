...
function draw() {
    ...
    for(i=0 ; i<objects.length ; i++) {
        document.getElementById("status").innerHTML = "Status: Detected objects." + "<br>" + "There are 2 living beings in this picture. Cocossd detected both of them." ;
