...
function preload() {
    img = loadImage('office table.jpg') ;
}
...
function draw() {
    ...
    for(i=0 ; i<objects.length ; i++) {
        document.getElementById("status").innerHTML = "Status: Detected objects." + "<br>" + "There are 4 objects in this picture. Cocossd detected all 4 of them." ;
